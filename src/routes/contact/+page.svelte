  ...
  >
    ...
    <div class="min-w-0 flex flex-col gap-8">
      ...
      <div class="flex gap-4">
        <span aria-hidden="true" class="text-brand-teal text-h3 leading-none mt-1">⌖</span>
        <div>
        ...
        <div class="flex flex-wrap gap-3">
          {#each socials as s (s.label)}
            <a
              ...
              rel="noopener noreferrer"
              aria-label={s.label}
              class="w-10 h-10 rounded-md border border-line bg-white text-ink-2
                     hover:text-brand-teal hover:border-brand-teal hover:-translate-y-0.5
